          ...
          [
            {
              ...
              'distance' => '300.0',
              'duration' => '0.01',
              'url' => "http://proxy.photostorage.localhost/originals/other/test3.gpx?fn=track3.gpx&id=#{token.id}"
            },
            {
              'id' => track2.id,
              'name' => 'track2',
              ...
              'distance' => '200.0',
              'duration' => '0.01',
              'url' => "http://proxy.photostorage.localhost/originals/other/test2.gpx?fn=track2.gpx&id=#{token.id}"
            }
          ]
        )
      end
